...
export const metadata: Metadata = {
  ...
  description:
    "Política de Privacidad del Instituto Pulso Fiscal. Tratamiento de datos personales aplicable a los usuarios del sitio.",
  openGraph: {
    title: "Política de Privacidad | Instituto Pulso Fiscal",
    description: "Política de privacidad y tratamiento de datos personales del Instituto Pulso Fiscal.",
    url: "/privacidad",
    type: "website",
    locale: "es_PE",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Política de Privacidad — Instituto Pulso Fiscal" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Política de Privacidad | Instituto Pulso Fiscal",
    description: "Tratamiento de datos personales del Instituto Pulso Fiscal.",
    images: ["/og-image.png"],
      ...
      <section className="bg-navy-950 pt-12 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white/40 text-sm max-w-lg mx-auto leading-relaxed">
            Tratamiento de datos personales aplicable a los usuarios del sitio web del Instituto Pulso Fiscal.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[820px] mx-auto px-6 pb-24">
          <div className="bg-white rounded-2xl shadow-lg shadow-navy-950/5 border border-slate-100 p-8 md:p-12">
            <p className="text-slate-600 text-[15px] leading-relaxed mb-8">
              Esta sección está preparada para publicar la política de privacidad y el tratamiento de datos personales aplicable a los usuarios del Instituto Pulso Fiscal.
            </p>
